...
<template>
    <div
        ...
        <div
            ...
            <div class="flex justify-start items-start self-stretch flex-grow-0 flex-shrink-0 relative gap-[15px]">
                ...
                <div class="flex justify-center items-center flex-grow relative gap-2">
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <g clip-path="url(#clip0_29323_902)">
                            ...
                            <path d="M3.33337 17.5L4.16671 16.25" stroke="#6366F1" stroke-width="1.66667"
                                stroke-linecap="round" stroke-linejoin="round"></path>
                            <path d="M16.6667 17.5L15.8334 16.25" stroke="#6366F1" stroke-width="1.66667"
                                stroke-linecap="round" stroke-linejoin="round"></path>
                        </g>
                        <defs>
                ...
                <div class="flex justify-end items-center flex-grow relative gap-2">
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <g clip-path="url(#clip0_29323_913)">
                            ...
                            <path d="M1.99988 13.1716L6.36359 17.5353" stroke="#6366F1" stroke-width="1.66667"
                                stroke-linecap="round" stroke-linejoin="round"></path>
                            <path d="M13.6361 17.5353L17.9998 13.1716" stroke="#6366F1" stroke-width="1.66667"
                                stroke-linecap="round" stroke-linejoin="round"></path>
                        </g>
                        <defs>
